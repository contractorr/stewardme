    ...
    <DashboardPageContainer className="space-y-6 py-4 md:py-6">
          ...
          <CardHeader className="space-y-2">
            <div className="space-y-1">
              ...
              <p className="text-sm text-muted-foreground">
                Use this as a shortcut, not a required order. The library below is for open browsing.
              </p>
            </div>
          </CardHeader>
      ...
      <section id="browse-guides" className="space-y-4">
        <div className="space-y-1">
          ...
          <p className="text-sm text-muted-foreground">
            Filter by topic or search directly. Browse order is neutral so you can choose your own path.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-4 rounded-xl border bg-card p-4">
          ...
          <p className="text-sm text-muted-foreground">
            Guides are shown alphabetically within the filters you choose.
          </p>
          {inProgressCount > 0 ? (
            <p className="text-sm text-muted-foreground">
              You currently have {inProgressCount} guide{inProgressCount === 1 ? "" : "s"} in progress.
            </p>
          ) : null}
        </div>
