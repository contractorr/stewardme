...
- Don't over-fetch — be strategic about which tools to call"""
    ...
    def build_agentic_system(cls, goals_summary: str = "") -> str:
        ...
        base = (
            ...
            "- Before suggesting a new learning guide, check the current curriculum catalog first\n"
            "- If the user explicitly asks for a missing learning guide, you may generate it\n"
            "- If you proactively think a missing learning guide would help, suggest it first and do "
            "not generate it without approval\n"
